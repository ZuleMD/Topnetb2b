                    ...
                    <div class="col-md-8 ml-auto mr-auto">
                        ...
                        <div class="card card-upgrade">
                            <div class="card-header text-center">
                                <h4 class="card-title">Ajouter Pack/Offre Commission</h3>
                            </div>
                            <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control @error('RefOffre') is-invalid @enderror" placeholder="Référence offre" name="RefOffre">
                                                    @error('RefOffre')
