            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="CinPasseport" class="col-md-4 col-form-label text-md-right">{{ __('Cin/Passeport') }}</label>

                            <div class="col-md-6">
                                <input id="CinPasseport" type="text" class="form-control @error('CinPasseport') is-invalid @enderror" name="CinPasseport" value="{{ old('CinPasseport') }}" required autocomplete="CinPasseport">
